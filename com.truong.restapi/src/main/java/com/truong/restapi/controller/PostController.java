...
public class PostController extends BaseController {
	...
	public ResponseEntity<BaseResponse<PostResponse>> create(@Valid @RequestBody PostRequest postRequest)
		...
		respponse.setData(new PostResponse(postService.spCreatePost(post)));
	...
	public ResponseEntity<BaseResponse<List<PostResponse>>> getAll(
		...
		List<Post> listPost = postService.findAll(status);
		
		respponse.setData(new PostResponse().mapToList(listPost));
